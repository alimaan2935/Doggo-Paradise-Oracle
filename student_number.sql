...
SELECT * FROM USER_CONS_COLUMNS WHERE TABLE_NAME = 'DOGS'
UNION
SELECT * FROM USER_CONS_COLUMNS WHERE TABLE_NAME = 'DOG_BREEDS'
UNION
SELECT * FROM USER_CONS_COLUMNS WHERE TABLE_NAME = 'CUSTOMERS'
UNION
SELECT * FROM USER_CONS_COLUMNS WHERE TABLE_NAME = 'STORES'
UNION
SELECT * FROM USER_CONS_COLUMNS WHERE TABLE_NAME = 'SERVICE_HISTORY'
UNION
SELECT * FROM USER_CONS_COLUMNS WHERE TABLE_NAME = 'SERVICE_HISTORY_DETAIL'
UNION
SELECT * FROM USER_CONS_COLUMNS WHERE TABLE_NAME = 'STORES';
